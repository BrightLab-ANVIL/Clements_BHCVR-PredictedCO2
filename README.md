...
`Check_CO2_quality.py` contains functions that can be used to assess the quality of an exhaled CO2 timeseries and better understand a participant's compliance during a breath hold task. We recommend using the functions in the following order:
